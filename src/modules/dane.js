...
export async function renderDane(root, ctx) {
  ...
  root.append(h('h1', {}, 'Dane i synchronizacja'), msg,
  ...
  root.append(h('section', { class: 'panel', 'aria-labelledby': 'h-sync' }, h('h2', { id: 'h-sync' }, 'Synchronizacja przez iCloud Drive'),
  ...
  if (store) {
    ...
    root.append(h('section', { class: 'panel', 'aria-labelledby': 'h-inv' }, h('h2', { id: 'h-inv' }, 'Kontrola stanów magazynu'),
  ...
  // --- Kopie automatyczne
  root.append(h('section', { class: 'panel', 'aria-labelledby': 'h-bk' }, h('h2', { id: 'h-bk' }, 'Kopie automatyczne'),
