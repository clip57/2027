...
[diet, supplements, catalog, training, cfa, safety, dayTemplate, week, phases, seeds, mealprep].forEach(deepFreeze);

export const SRC = { diet, supplements, catalog, training, cfa, safety, dayTemplate, week, phases, seeds, mealprep };
