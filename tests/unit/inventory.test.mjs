...
import { stockAt, forecast, status, shoppingList, nextShopping, allItems } from '../../src/core/calc/inventory.js';
...
test('statusy — progi v31', () => {
  const supp = catalogById.omega3, food = catalogById.kefir;
